    ...
    <el-row :gutter="10" class="mb8">
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleAdd"
          v-hasPermi="['preferentialmarketing:subject:add']"
        >新增</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="single"
          @click="handleUpdate"
          v-hasPermi="['preferentialmarketing:subject:edit']"
        >修改</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          :disabled="multiple"
          @click="handleDelete"
          v-hasPermi="['preferentialmarketing:subject:remove']"
        >删除</el-button>
      </el-col>
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['preferentialmarketing:subject:export']"
        >导出</el-button>
      </el-col>
...
<script>
import { listSubject, getSubject, delSubject, addSubject, updateSubject } from "@/api/preferentialmarketing/subject";
...
export default {
  ...
  data() {
    return {
      ...
      // 总条数
      total: 0,
      // 首页专题【jd首页下面很多专题，每个专题链接新的页面，展示专题商品信息】表格数据
      subjectList: [],
      // 弹出层标题
      title: "",
      // 是否显示弹出层
  ...
  methods: {
    ...
    handleAdd() {
      this.reset();
      this.open = true;
      this.title = "添加首页专题【jd首页下面很多专题，每个专题链接新的页面，展示专题商品信息】";
    },
    /** 修改按钮操作 */
    handleUpdate(row) {
      this.reset();
      ...
      getSubject(id).then(response => {
        ...
        this.open = true;
        this.title = "修改首页专题【jd首页下面很多专题，每个专题链接新的页面，展示专题商品信息】";
      });
    },
    /** 提交按钮 */
    submitForm() {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('是否确认删除首页专题【jd首页下面很多专题，每个专题链接新的页面，展示专题商品信息】编号为"' + ids + '"的数据项？').then(function() {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('preferentialmarketing/subject/export', {
        ...this.queryParams
