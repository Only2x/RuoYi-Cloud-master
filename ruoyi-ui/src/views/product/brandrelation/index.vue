<template>
  <div class="app-container">
    <el-form :model="queryParams" ref="queryForm" size="small" :inline="true" v-show="showSearch" label-width="68px">
      ...
      <el-form-item label="${comment}" prop="brandName">
        <el-input
      ...
      <el-form-item label="${comment}" prop="catelogName">
        <el-input
          v-model="queryParams.catelogName"
          placeholder="请输入${comment}"
          clearable
          @keyup.enter.native="handleQuery"
        />
    ...
    <el-table v-loading="loading" :data="brandrelationList" @selection-change="handleSelectionChange">
      ...
      <el-table-column label="${comment}" align="center" prop="brandName" />
      <el-table-column label="${comment}" align="center" prop="catelogName" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="80px">
        ...
        <el-form-item label="${comment}" prop="brandName">
          <el-input v-model="form.brandName" placeholder="请输入${comment}" />
        </el-form-item>
        <el-form-item label="${comment}" prop="catelogName">
          <el-input v-model="form.catelogName" placeholder="请输入${comment}" />
        </el-form-item>
      </el-form>
...
<script>
import { listBrandrelation, getBrandrelation, delBrandrelation, addBrandrelation, updateBrandrelation } from "@/api/product/brandrelation";
