    ...
    <el-row :gutter="10" class="mb8">
      ...
      <el-col :span="1.5">
        <el-button
          ...
          size="mini"
          @click="handleExport"
          v-hasPermi="['member:address:export']"
        >导出</el-button>
      </el-col>
...
<script>
import { listAddress, getAddress, delAddress, addAddress, updateAddress } from "@/api/member/address";
...
export default {
  ...
  methods: {
    ...
    /** 导出按钮操作 */
    handleExport() {
      this.download('member/address/export', {
        ...this.queryParams
